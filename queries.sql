...
SELECT publico_pagante FROM estadios WHERE publico_pagante > 100000;

SELECT publico_pagante FROM estadios WHERE publico_pagante > 50000 AND publico_pagante < 100000;

SELECT estadio from estadios WHERE estadio LIKE '%y';

ALTER TABLE estadio ALTER COLUMN ano TYPE integer USING (trim(ano)::integer);
